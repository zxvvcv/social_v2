...
import 'package:app/screens/comments_screen2.dart';
...
class _PostCardState extends State<PostCard2> {
  ...
  void getComments() async {
    ...
    QuerySnapshot snap = await FirebaseFirestore.instance.collection('posts2').doc(widget.snap['postId']).collection('comments').get();
            ...
            children: [
              ...
              IconButton(
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => CommentsScreen2(
                      snap: widget.snap,
                    ),
                  ),
                ),
